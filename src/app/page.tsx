...
export default function Home() {
  return (
    <main>
      ...
      <section id="about" className="min-h-screen flex items-center justify-center bg-neutral-950">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-16 md:py-20 lg:py-28">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">About Us</h2>
          <p className="text-lg text-neutral-400 max-w-3xl">
            We are driven by excellence and passion for innovation. Our team creates trends
